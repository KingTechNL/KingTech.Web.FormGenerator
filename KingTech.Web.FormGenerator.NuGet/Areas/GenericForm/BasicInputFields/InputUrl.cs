...
/// <summary>
/// This input field is used for URIs.
/// </summary>
/// <typeparam name="TValue">The actual type of this URI.</typeparam>
public class InputUrl<TValue> : InputDate<TValue>
{
    ...
    protected override bool TryParseValueFromString(string? value, [MaybeNullWhen(false)] out TValue result, [NotNullWhen(false)] out string? validationErrorMessage)
    {
        ...
        {
            throw new InvalidOperationException($"The type '{targetType}' is not a supported uri type.");
        }
